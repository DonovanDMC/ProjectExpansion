...
public enum Fuel {
    ...
    AETERNALIS("aeternalis", false, 3, ObjHandler.aeternalisFuel::asItem),
    ...
    private void register(RegistrationType reg) {
        ...
        switch (reg) {
            ...
            case BLOCK: {
                block = Blocks.Registry.register(String.format("%s_fuel_block", name), () -> new Block(Block.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(0.5F, 1.5F)));
