...
public enum Matter {
    ...
    Matter(long collectorOutput, long relayBonus, long relayTransfer, @Nullable Supplier<Item> existingItem) {
        ...
        this.collectorOutputBase = BigInteger.valueOf(collectorOutput);
        // ¯\_(ツ)_/¯
        this.relayBonusBase = BigInteger.valueOf(relayBonus);
        // Gₙ(aₙ)(z)=64(2z²+z-1)/4z-1
        this.relayTransferBase = BigInteger.valueOf(relayTransfer);
    ...
    */
    ...
    public Component getEMCLinkItemLimitComponent() {
        return Component.translatable(this == FINAL ? "INFINITY" : String.valueOf(getEMCLinkItemLimit()));
    }

    public Component getEMCLinkFluidLimitComponent() {
        return Component.translatable(this == FINAL ? "INFINITY" : String.valueOf(getEMCLinkFluidLimit()));
    }
