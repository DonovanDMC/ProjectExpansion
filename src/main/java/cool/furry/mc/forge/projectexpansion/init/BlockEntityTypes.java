...
public class BlockEntityTypes {
    ...
    public static final RegistryObject<BlockEntityType<BlockEntityCollector>> ENERGY_COLLECTOR = Registry.register("collector", () -> BlockEntityType.Builder.of(BlockEntityCollector::new, Arrays.stream(Matter.VALUES).map(Matter::getCollector).toArray(Block[]::new)).build(null));
