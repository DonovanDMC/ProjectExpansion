...
public class EMCFormat extends DecimalFormat {
    ...
    public static ITextComponent getComponent(long value) {
        return getComponent(BigDecimal.valueOf(value));
    }
    public static ITextComponent getComponent(BigInteger value) {
        return getComponent(new BigDecimal(value));
    }
    public static ITextComponent getComponent(BigDecimal value) {
