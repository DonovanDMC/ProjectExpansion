...
public final class Config {
    ...
    public static final ForgeConfigSpec.ConfigValue<Boolean> notifyEMCChanges = Builder.translation("gui.projectexpansion.config.notify_emc_changes.desc").define("notifyEMCChanges", true);
